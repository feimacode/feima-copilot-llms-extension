...
const sidebarBilingual = [
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'guides/local-endpoints', translations: { 'zh-CN': '本地与企业模型端点' } },
...
const sidebarEnOnly = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Local & Enterprise Endpoints', link: '/guides/local-endpoints' },
...
const sidebarZhOnly = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '本地与企业模型端点', link: '/guides/local-endpoints' },
      { label: '配置', link: '/guides/configuration' },
      { label: '工具模型配置', link: '/guides/utility-models' },
