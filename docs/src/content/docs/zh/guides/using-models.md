...
**推荐**：Qwen3 Coder Plus、DeepSeek V4 Pro
...
| 预算水平 | 推荐模型 | 说明 |
|----------|----------|------|
| **免费（公测）** | Qwen3 Flash、Qwen3.7 Plus | 0.1x/0.5x 倍率，免费使用 |
| **低成本** | Qwen3.5 Plus、DeepSeek V4 Flash | 0.5x 倍率，高性价比 |
| **标准** | Qwen3 Max、DeepSeek V3.2、GLM-4.7 | 1.0x 倍率 |
| **高级** | Qwen3 Coder Plus、GLM-5、GLM 5.1 | 2.0x 倍率，最佳性能 |
