...
Provides a visual `TreeView`, nested under VS Code's Explorer, for inspecting and managing registered local/enterprise model endpoints — their scope, health, and discovered models — without requiring the user to work through command-only flows.
