...
- 🚀 **无需梯子** - 国内直连，稳定快速
- 🤖 **多模型支持** - Qwen、DeepSeek、智谱 GLM、MiniMax、小米、月之暗面、腾讯混元等主流模型
...
| **Qwen3.8 Flash** | 阿里云 | 极速响应，~1M token | 🟦 最便宜 |
...
| **GLM 5.3** | 智谱 | 1M token 上下文，高级推理 | 🟨 进阶 |
| **GLM 5.3 Flash** | 智谱 | 1M token 上下文，快速响应 | 🟩 标准 |
| **Grok 4.6** | xAI | 500K 上下文，视觉，可配置推理 | 🟧 专业 |
| **GPT 5.6 Luna** | OpenAI | 1M 上下文，视觉，推理，经济高效 | 🟩 标准 |
| **MiniMax M2.5** | MiniMax | 高效推理，200K token，思维链能力 | 🟩 标准 |
| **MiniMax M3** | MiniMax | 1M token 上下文，高级推理 | 🟧 专业 |
| **Kimi K2.6** | 月之暗面 | **超长文本**，256K token，思维链推理，视觉 | 🟩 标准 |
| **Kimi K2.7 Code** | 月之暗面 | 256K token，代码专精，视觉 | 🟩 标准 |
| **Mimo V2.5** | 小米 | 1M token 上下文，视觉，高级推理 | 🟩 标准 |
| **Mimo V2.5 Pro** | 小米 | 1M token 上下文，视觉，推理（Pro） |
| **Kimi K3** | 月之暗面 | **超长文本**，1M token，深度思考，视觉 | 🟧 专业 |
| **HY3** | 腾讯混元 | 256K token 上下文，思维链支持 | 🟩 标准 | 🟧 专业 |
| **HY4 Preview** | 腾讯混元 | 1M token 上下文，思维链支持（预览） | 🟩 标准 |
...
| **免费额度** | 仅限轻量模型（Haiku 4.5、GPT-5 mini） | ✅ 注册即得 200 次，所有模型可用 |
| **价格** | $10/月 + 超额费用 | $10 一次性（500次） |

**关键优势**：飞码扣免费额度覆盖全部模型，包括 Copilot 免费版无法使用的高级模型！
...
**Q: 公测期间如何获取免费额度？**
A: 多种方式获取：邀请好友（双方获得奖励）、参与活动（定期活动赚取额外积分）。[了解详情 →](https://feimacode.com/promotion)
